...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2019 at 01:38 AM
...
INSERT INTO `users` (`id`, `name`, `email`, `user_type`, `status`, `email_verified_at`, `password`, `remember_token`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 'Jeric E. Mangao', 'mangao_jeric@yahoo.com', 'Administrator', 'Activate', NULL, '$2y$10$k8s2cJwVxYnZN50GrMio.eVk15OAI1ZONbzO5paDgU82f4513qa1a', NULL, NULL, '2019-06-30 23:43:04', '2019-06-30 23:43:04');
