<template>
    <div class="container">
        ...
        <!-- Output 4-6 numbers  -->
        <div class="row mb-2">
            <div class="col-lg-3" v-for="(n, index) in getNumbers(4,7)" :key="index">
                <button class="btn btn-secondary btn-block py-3 font-weight-bold"   @click="type(n)">
                    {{ n }}
                </button>
            </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-3">
                <button class="btn btn-danger btn-block py-3 font-weight-bold" @click="closeModal()" title="CLEAR ALL">
